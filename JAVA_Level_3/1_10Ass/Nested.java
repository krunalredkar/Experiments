/*********************************************************************************************************************
	...
	a program to demonstrate the use of nested class and its objects when nested class is a
		a) private member of the outer class
		b) public member of the outer class.

	@Author 	- Krunal Redkar
	@Title		- DSSD-JAVA
...
**********************************************************************************************************************/
 ...
 { 	
 	...
 	// acces while inner is private
 	public void getPrivateDataId(int i_id)
 	{
 ...
 class Nested
 {
	public static void main(String args[])
	{
		...
		/**********************************************************************************************
		 *	If Inner class is private
		 **********************************************************************************************/
		o.getPrivateDataId(2);
